...
class Player:
    def __init__(self, colour):
        ...
        self.placing = Placing(self.colour, self.board)
    ...
    def action(self, turns):
        ...
        #self.board.count += 1
        #return self.placing.placeing_phase()
        #Moving Phase
        else:
    ...
    def update(self, action):
        ...
        #Moving phase action
            ...
            if self.board.count == 128 + 24 or self.board.count == 192 + 24:
                self.decrease_board()
            piece = self.board.find_piece(action[0])
            if piece:
                self.minimax.makemove(action[1], self.enemy, piece)
    ...
    def decrease_board(self):
        ...
        corners = [(buf, buf), (buf, 7 - buf), (7 - buf, 7 - buf), (7 - buf, buf)]
        ...
        for square in corners:
            ...
            corner_piece = Piece('X', square, self.board)
            corner_piece.corner_move(square, 'X', corner_piece)
