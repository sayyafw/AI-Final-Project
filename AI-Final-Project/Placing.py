...
class Placing:
    ...
    def placeing_phase(self):
        ...
        self.max(turn, 0, a, b)
        #place the best move onto the board and return it
        self.place(self.best[0], self.best[1], self.symbol)
        print(self.best[0], self.best[1], self.symbol)
        self.board.grid[self.best[0], self.best[1]] = self.symbol
        ...
        if (len(self.history) > 0):
            ...
            if self.history[-1][0] == "Placing":
                ...
                if self.history[-1][1] == "B":
                    ...
                    piece = Piece("@", self.history[-1][2], self.board)
                    if self.colour == "white":
                        self.enemy_list.append(piece)
                    else:
                        self.piece_list.append(piece)
                    piece.makemove(self.history[-1][2])
                    ...
                    ###############place white
                    piece = Piece("O", self.history[-1][2], self.board)
                    if self.colour == "white":
                        self.piece_list.append(piece)
                    else:
                        self.enemy_list.append(piece)
